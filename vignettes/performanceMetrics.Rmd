...
dmns=dimnames(refpts(ple4brp))
dmns$refpt=c(dmns$refpt,"-0.25MSY","+0.25MSY")
refpts(ple4brp)     =FLPar(NA,dimnames=dmns)

refpts(ple4brp)["-0.25MSY"]=c(msy[1,1]*0.5, msy[1,2]*0.75,rep(NA,6))
refpts(ple4brp)["+0.25MSY"]=c(msy[1,1]*2.0, msy[1,2]*0.75,rep(NA,6))
refpts(ple4brp)    =computeRefpts(ple4brp)

ple4brp=brp(ple4brp)
plot(ple4brp,ncol=2,refpts=c("-0.25MSY","msy","+0.25MSY"))
```
